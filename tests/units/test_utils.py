...
def test_get_past_competitions():
    past_competitions = utils.get_past_competitions(TEST_COMPETITIONS['competitions'])
    assert len(past_competitions) == 1


def test_get_future_competitions():
    future_competitions = utils.get_future_competitions(TEST_COMPETITIONS['competitions'])
